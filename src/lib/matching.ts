...
// Runs on brief approval over APPROVED providers; no AI required for v1.
...
/**
 * Rank APPROVED providers for a brief. Keeps the top 6 with score ≥ 60;
 * if fewer than 3 clear the threshold, falls back to the top 3 overall so
 * the client always gets recommendations (acceptance criteria §15.1).
 */
